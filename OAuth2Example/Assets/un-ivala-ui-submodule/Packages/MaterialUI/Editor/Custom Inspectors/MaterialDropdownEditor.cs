...
namespace MaterialUI
{
    ...
    {
		// SS_BEGIN
		private SerializedProperty m_DropdownPanelPrefabName;
		// SS_END
        ...
        void OnEnable()
        {
			...
			// SS_BEGIN
			m_DropdownPanelPrefabName = serializedObject.FindProperty("m_DropdownPanelPrefabName");
			// SS_END
        ...
        public override void OnInspectorGUI()
        {
			...
			// SS_BEGIN
			EditorGUILayout.PropertyField(m_DropdownPanelPrefabName);
			// SS_END
