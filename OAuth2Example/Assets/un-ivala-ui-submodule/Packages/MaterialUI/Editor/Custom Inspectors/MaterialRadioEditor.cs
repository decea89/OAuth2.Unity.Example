...
namespace MaterialUI
{
	...
	class MaterialRadioEditor : MaterialToggleBaseEditor
    {
        ...
        // [SS] BEGIN
        private SerializedProperty m_DotImageSize;
        // [SS] END
        ...
        protected override void OnEnable()
        {
            ...
            // [SS] BEGIN
            m_DotImageSize = serializedObject.FindProperty("m_DotImageSize");
            // [SS] END
        ...
        // [SS] BEGIN
        protected override void CustomSection()
        {
            EditorGUILayout.PropertyField(m_DotImageSize);
        }
        // [SS] END
