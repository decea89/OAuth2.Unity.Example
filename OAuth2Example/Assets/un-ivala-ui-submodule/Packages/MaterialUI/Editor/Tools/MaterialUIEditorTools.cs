...
namespace MaterialUI
{
    ...
    public static class MaterialUIEditorTools
    {
        ...
        public static void CreateInstance(string assetPath, string objectName, params int[] instantiationOptions)
        {
			...
			m_LastInstance = Object.Instantiate(AssetDatabase.LoadAssetAtPath( Utils.MaterialUIPath + "Prefabs/" + assetPath + ".prefab", typeof(GameObject))) as GameObject;
			// SS_END
        ...
        private static void CreateCanvasIfNeeded()
        {
            ...
            if (m_NotCanvas)
            {
                ...
                {
					// SS_BEGIN fixed assets path
					Object.Instantiate(AssetDatabase.LoadAssetAtPath( Utils.MaterialUIPath + "Prefabs/Common/EventSystem.prefab", typeof(GameObject))).name = "EventSystem";
					// SS_END
                }
                ...
                {
					// SS_BEGIN fixed assets path
					m_SelectedObject = Object.Instantiate(AssetDatabase.LoadAssetAtPath(Utils.MaterialUIPath + "Prefabs/Common/Canvas.prefab", typeof(GameObject))) as GameObject;
					// SS_END
