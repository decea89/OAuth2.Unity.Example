...
namespace MaterialUI
{
    ...
    public class MaterialButton : UIBehaviour, ILayoutGroup, ILayoutElement, ILayoutSelfController
    {
		...
		/// </summary>
		// SS_BEGIN fixed assets path
		private const string pathToCirclePrefab = Utils.MaterialUIPath + "Prefabs/Components/Buttons/Floating Action Button.prefab";
        /// <summary>
        /// Path to the rectangular button prefab.
        /// </summary>
		private const string pathToRectPrefab = Utils.MaterialUIPath + "Prefabs/Components/Buttons/Button.prefab";
		// SS_END
        ...
        public string textText
        {
            get { 
                string Result  = "";
                if ( m_Text != null ) Result = m_Text.text;
                if ( m_TextMeshPro != null ) Result = m_TextMeshPro.text;
                return Result;
            }
            set { 
                if ( m_Text != null )
...
#if UNITY_EDITOR
			// SS_BEGIN fixed assets path
			string flatRoundedSquare = Utils.MaterialUIPath + "Images/RoundedSquare/roundedsquare_";
			string raisedRoundedSquare =  Utils.MaterialUIPath + "Images/RoundedSquare_Stroke/roundedsquare_stroke_";
			// SS_END
