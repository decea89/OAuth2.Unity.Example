...
namespace MaterialUI
{
    ...
    public class MaterialInputField : UIBehaviour, ILayoutGroup, ILayoutElement, ISelectHandler, IDeselectHandler
    {
        ...
        private float GetSmallHintTextHeight()
        {
            ...
            if (materialUiScaler == null || materialUiScaler.scaler==null)
            {
                return 0;
            }
        ...
        //BEGIN BUGFIX input text . Restored on submitt answer. ++ InputFieldController.cs
            public void ResetInputTextOffset() {

                    inputTextTransform.offsetMin = Vector2.zero;
                    inputTextTransform.offsetMax = Vector2.zero;
            }
        ...
        public void CalculateLayoutInputHorizontal()
        {
            ...
            if (m_LeftContentTransform != null)
            {
                if (m_LeftContentTransform.gameObject.activeSelf)
                {
					...
					// [ss] begin
					m_LeftSectionWidth += m_LeftContentOffset.x;
					// [ss] end
            ...
            if (m_RightContentTransform != null)
            {
                if (m_RightContentTransform.gameObject.activeSelf)
                {
					...
					// [ss] begin
					m_RightSectionWidth += m_RightContentOffset.x;
					// [ss] end
