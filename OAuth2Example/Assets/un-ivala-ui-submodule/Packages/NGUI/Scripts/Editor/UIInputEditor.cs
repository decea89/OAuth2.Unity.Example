...
public class UIInputEditor : UIWidgetContainerEditor
{
	public override void OnInspectorGUI ()
	{
		...
		EditorGUI.BeginDisabledGroup(label == null || label.objectReferenceValue == null);
		{
			...
			// [ss] merge begin
			NGUIEditorTools.DrawPaddedProperty("Ignore Up and Down keys", serializedObject, "mIgnoreUpAndDownKeys");
			NGUIEditorTools.DrawPaddedProperty("ReadOnly", serializedObject, "mReadOnly");
			// [ss] merge end
