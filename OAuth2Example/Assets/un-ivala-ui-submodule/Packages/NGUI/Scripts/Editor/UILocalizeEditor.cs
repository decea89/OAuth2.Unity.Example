...
// [SS] BEGIN
		SerializedProperty tmProProp = NGUIEditorTools.DrawProperty("TextMeshPro", serializedObject, "textMeshPro");
		SerializedProperty textProp = NGUIEditorTools.DrawProperty("UGUIText", serializedObject, "text");
// [SS] END
