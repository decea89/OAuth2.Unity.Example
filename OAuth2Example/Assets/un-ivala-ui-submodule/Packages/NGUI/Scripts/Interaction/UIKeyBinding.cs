...
public class UIKeyBinding : MonoBehaviour
{
	...
	protected virtual void Update ()
	{
        ...
        //[SS] merge start
        if ( !anyKey && (keyCode == KeyCode.None || !IsModifierActive())) return;
        // [SS] merge end

        //[SS] merge start
        bool keyDown = anyKey ? Input.anyKeyDown : Input.GetKeyDown(keyCode);
		bool keyUp = anyKey ? (!Input.anyKey) : Input.GetKeyUp(keyCode);
        // [SS] merge end
