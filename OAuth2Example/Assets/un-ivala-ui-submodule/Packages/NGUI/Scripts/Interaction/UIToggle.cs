...
public class UIToggle : UIWidgetContainer
{
	...
	//[ss] mergeme begin
	public bool m_IgnoreOnClick = false;
	//[ss] mergeme end
	...
	/// </summary>
	//[ss] mergeme begin
	public void OnClick () { if (enabled && !m_IgnoreOnClick) value = !value; }

	public void Set_True(){ Set (true); }

	public void Set_False(){ Set (false); }
