...
public class UIInput : MonoBehaviour
{
	...
	// [ss] merge begin
	public bool mIgnoreUpAndDownKeys = false;
	...
	protected virtual void Update ()
	{
		...
		if (isSelected)
		{
			...
			// Blink the caret
			// [ss] mergeme begin
			if (mCaret != null && mNextBlink < RealTime.time && !mReadOnly)
			// [ss] mergeme end
			{
			...
			// [ss] merge begin
			if ( !mReadOnly && ( Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.KeypadEnter) ))
			// [ss] merge end
			{
